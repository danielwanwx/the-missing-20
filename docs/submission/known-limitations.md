...
| --- | --- | --- |
| Stable real Nova usefulness | `NOT_PROVEN` | The consumed real attempt degraded before yielding a stable useful advisory trace. The package uses the scripted trace for the investigation story and labels the real result honestly. |
...
any provider budget, cloud deployment, public release, or production data. This private
package does not imply or schedule that work.
